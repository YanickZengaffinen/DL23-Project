#!/usr/bin/env python3
# Adjusted from .../site-packages/learn2learn/vision/models/resnet12.py
...
class ResNet(nn.Module):
    def __init__(self, z_length, i_cha, i_dim, k_size):
        super(ResNet, self).__init__()
        self.z_length = z_length
        self.i_cha = i_cha
        self.i_dim = i_dim
        resnet18 = models.resnet18(pretrained=False)
        resnet18.conv1 = torch.nn.Conv2d(i_cha, 64, kernel_size=(k_size, k_size), stride=(1, 1), padding=(3, 3), bias=False)
